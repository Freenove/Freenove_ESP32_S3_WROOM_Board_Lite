...
In this tutorial, the ESP32-S3 WROOM Lite is designed based on the PCB on-board antenna-packaged ESP32-S3-WROOM-1 module. 
...
.. list-table:: 
   ...
   * -  ESP32-S3 WROOM Lite N16R8
     -  ESP32-S3 WROOM Lite N8R8

   * -  |Preface94|
     -  |Preface02|

.. |Preface02| image:: ../_static/imgs/Preface/Preface02.png
.. |Preface94| image:: ../_static/imgs/Preface/Preface94.png
